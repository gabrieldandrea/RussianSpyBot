module.exports = {
  ...
  execute(message, args) {
    ...
    const helpEmbed = new Discord.MessageEmbed()
      ...
      .addFields({
        name: "**!wires**",
        value: "Explains how to defuse the wires, type the number of wires and then respond yes and no"
      })
      .addFields({
        name: "**!button**",
      ...
      .addFields({
        name: "**!keypad**",
        value: "Explains how to defuse the keypad, enter the keypad symbols seperated by a space"
      })
      .addFields({
        name: "**!keypadsymbols**",
      ...
      .addFields({
        ...
        value: "Explains how to defuse complicated wires, input the colour(s) of the wire, enter the word 'led' if the LED is lit, and enter the word 'star' if there is a star symbol"
      });
