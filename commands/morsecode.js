module.exports = {
    ...
    execute(message, args) {
        ...
        var letters = [];
        message.reply("Enter the ordered letters in dots and dashes, seperate the letters by a space. These messages will expire in 30 seconds").then(r => r.delete({ timeout: 30000 }));
